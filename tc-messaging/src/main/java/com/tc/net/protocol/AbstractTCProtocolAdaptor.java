...
//  }
  ...
  abstract protected TCNetworkMessage createMessage(TCConnection source, TCNetworkHeader hdr, TCByteBufferReference data)
  ...
  private TCNetworkMessage processPayloadData(TCConnection source, TCByteBuffer[] data, Queue<TCByteBuffer> recycle) throws TCProtocolException {
    ...
    if (0 == dataBytesNeeded) {
      ...
      // message is complete!
      TCNetworkMessage msg = createMessage(source, header, new TCByteBufferReference(Arrays.asList(localDataBuffers), recycle));
